...
/**
 * Class LogisticsTraceInfoParams
 * @package AlibabaOpen\entity\order
 * @property \AlibabaOpen\entity\order\LogisticsTraceInfoParams $logisticsId
 * @property \AlibabaOpen\entity\order\LogisticsTraceInfoParams $webSite
 */
